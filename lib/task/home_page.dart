...
import 'package:blink_list/task/todo_item.dart';
...
class _HomePageState extends State<HomePage> {
    ...
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        appBarTheme: AppBarTheme(
          backgroundColor:
              isDarkMode ? Colors.grey[900] : Colors.deepPurple[50],
          elevation: 0,
        ),
      ),
      home: Scaffold(
                        ...
                        children: [
                          ...
                          for (ToDo todo in _foundToDo.reversed)
                            ToDoItem(
                              ...
                              onUpdateItem:
                                  _updateToDoItem, // Passez la fonction ici
                            ),
                        ],
                      ),
                    ),
  ...
  void _updateToDoItem(String id, String newTodoText) {
    setState(() {
      ...
      if (index != -1) {
        todosList[index].todoText = newTodoText;
      }
    });
  }
    ...
    if (pickedDate != null) {
      setState(() {
        todosList.add(ToDo(
          ...
          todoText: toDo,
          dateAdded: pickedDate, // assuming ToDo has a dateAdded field
        ));
      });
